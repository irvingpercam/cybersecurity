#ifndef RIJNDAEL_H
#define RIJNDAEL_H
/* ENCRYPTION: Rijndael S BOX*/
// Tabla de Rijndael, obtenida de: https://cryptography.fandom.com/wiki/Rijndael_S-box
// La S-Box es una tabla de sustitución usada en el cifrado Rijndael, de donde se basa AES.
...
// ENCRYPTION: GALOIS MULTIPLICATION LOOKUP TABLES
// Estas tablas son utilizadas para la multiplicacion de bytes.
unsigned char mul2[] = {
...
// DECRYPTION: GALOIS MULTIPLICATION LOOKUP TABLES
// Estas tablas son utilizadas para la multiplicacion de bytes.
